...
def pargs():
  ...
  parser.add_argument("-lrhigh",default=0.25,type=float,help="high learning rate for cycling")
  parser.add_argument("-lrstep",default=5, type=int,help='steps in cycle')
